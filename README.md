...
- [community-scripts/ProxmoxVE](https://github.com/community-scripts/ProxmoxVE) ([2025-01-13](https://github.com/community-scripts/ProxmoxVE/releases/tag/2025-01-13), today) - Proxmox VE Helper-Scripts (Community Edition) 
- [palantir/go-githubapp](https://github.com/palantir/go-githubapp) ([v0.32.0](https://github.com/palantir/go-githubapp/releases/tag/v0.32.0), 5 days ago) - A simple Go framework for building GitHub Apps
...
- [GitHub Actions: Fix Shellsheck workflow to only run on changes `*.sh` files](https://github.com/community-scripts/ProxmoxVE/pull/1423) on [community-scripts/ProxmoxVE](https://github.com/community-scripts/ProxmoxVE) (3 days ago)
- [WIP: Github Actions: Fix &#34;Get changed files&#34; in Shellcheck workflow](https://github.com/community-scripts/ProxmoxVE/pull/1422) on [community-scripts/ProxmoxVE](https://github.com/community-scripts/ProxmoxVE) (3 days ago)
- [Prometheus: Fix installation via creating the service file](https://github.com/community-scripts/ProxmoxVE/pull/1416) on [community-scripts/ProxmoxVE](https://github.com/community-scripts/ProxmoxVE) (3 days ago)
- [Update Prometheus &#43; Alertmanager: Unify scripts for easier maintenance](https://github.com/community-scripts/ProxmoxVE/pull/1402) on [community-scripts/ProxmoxVE](https://github.com/community-scripts/ProxmoxVE) (4 days ago)
- [Visual Studio Code: Set Workspace recommended extensions](https://github.com/community-scripts/ProxmoxVE/pull/1398) on [community-scripts/ProxmoxVE](https://github.com/community-scripts/ProxmoxVE) (4 days ago)
