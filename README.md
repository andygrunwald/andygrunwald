...
- [community-scripts/ProxmoxVE](https://github.com/community-scripts/ProxmoxVE) ([2026-02-03](https://github.com/community-scripts/ProxmoxVE/releases/tag/2026-02-03), 1 day ago) - Proxmox VE Helper-Scripts (Community Edition) 
...
- [andygrunwald/oil-price-scraper](https://github.com/andygrunwald/oil-price-scraper) ([v1.0.1](https://github.com/andygrunwald/oil-price-scraper/releases/tag/v1.0.1), 1 week ago) - A price scraper for heating oil from multiple providers and stores the results in a PostgreSQL database
...
- [Prometheus Paperless NGX Exporter: Set correct binary path in systemd unit file](https://github.com/community-scripts/ProxmoxVE/pull/11438) on [community-scripts/ProxmoxVE](https://github.com/community-scripts/ProxmoxVE) (4 days ago)
