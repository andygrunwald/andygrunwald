...
- [Aiven-Open/karapace](https://github.com/Aiven-Open/karapace) ([3.14.0](https://github.com/Aiven-Open/karapace/releases/tag/3.14.0), 2 days ago) - Karapace - Your Apache Kafka® essentials in one tool
- [oicdb/oicdb-repository](https://github.com/oicdb/oicdb-repository) ([v0.0.1-beta3](https://github.com/oicdb/oicdb-repository/releases/tag/v0.0.1-beta3), 5 days ago) - The OICDB repository with all invoice collector recipes.
