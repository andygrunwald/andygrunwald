...
- [buchhalter-ai/homebrew-buchhalter](https://github.com/buchhalter-ai/homebrew-buchhalter) - Homebrew tap of buchhalter.ai-cli (5 days ago)

### 🔭 Latest releases I've contributed to


- [Aiven-Open/karapace](https://github.com/Aiven-Open/karapace) ([3.13.1](https://github.com/Aiven-Open/karapace/releases/tag/3.13.1), 1 week ago) - Karapace - Your Apache Kafka® essentials in one tool
...
- [Rector: Run rector to match current config (`LevelSetList::UP_TO_PHP_80`)](https://github.com/lansuite/lansuite/pull/1155) on [lansuite/lansuite](https://github.com/lansuite/lansuite) (1 week ago)
